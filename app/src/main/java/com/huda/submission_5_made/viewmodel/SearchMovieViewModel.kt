...
class SearchMovieViewModel : ViewModel() {
    ...
    internal fun setFilm(search: String, language: String, category: String) {
        val client = AsyncHttpClient()
        val listItems = ArrayList<RootData>()
        val url = "https://api.themoviedb.org/3/search/$category?query=$search&api_key=$API_KEY&language=$language&page=1"
