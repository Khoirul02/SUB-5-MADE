...
class DetailTvShowActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val title = resources.getString(R.string.title_tv_show_detail)
        ...
        img_favorite.setOnClickListener {
            val data = DataFilm(idfilm = data.id, name = data.name, photo = data.photo, description = data.description, date = data.date , rate = data.rate, category = "tv")
