...
import com.huda.submission_5_made.ui.activity.DetailTvShowActivity
...
class TvShowFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val category = getString(R.string.category_tv)
    ...
    override fun onCreateOptionsMenu(menu: Menu, inflater: MenuInflater) {
        ...
        searchView.setOnQueryTextListener(object : SearchView.OnQueryTextListener {
            override fun onQueryTextSubmit(query: String): Boolean {
                ...
                mainViewModelSearch = ViewModelProvider(this@TvShowFragment).get(SearchMovieViewModel::class.java)

                mainViewModelSearch.setFilm(query,language,category)

                showLoading(true)
                mainViewModelSearch.getFilm().observe(this@TvShowFragment, Observer { filmItems ->
                    if (filmItems != null) {
                        adapter.setData(filmItems)
                        showLoading( false)
                    }else{
