...
import com.huda.submission_5_made_favorite.ui.fragment.LoadFavoriteCallback
import java.lang.ref.WeakReference

class LoadFavoriteTask(context: Context, private val callback: LoadFavoriteCallback) : AsyncTask<Void, Void, ArrayList<DataFilm>>() {
