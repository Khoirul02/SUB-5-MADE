...
object MappingHelper {
    fun mapmapCursorToArrayList(filmCursor: Cursor): ArrayList<DataFilm> {
        ...
        while (filmCursor.moveToNext()){
            ...
            val name = filmCursor.getString(filmCursor.getColumnIndexOrThrow(DatabaseContract.MovieFavorite.NAME))
            val photo = filmCursor.getString(filmCursor.getColumnIndexOrThrow(DatabaseContract.MovieFavorite.PHOTO))
            val description = filmCursor.getString(filmCursor.getColumnIndexOrThrow(DatabaseContract.MovieFavorite.DESCRIPTION))
...
//        val date = filmCursor.getString(filmCursor.getColumnIndexOrThrow(DatabaseContract.MovieFavorite.DATE))
//        val category = filmCursor.getString(filmCursor.getColumnIndexOrThrow(DatabaseContract.MovieFavorite.CATEGORY))
//        return DataFilm(idfilm, name, photo, description, rate, date, category, id
//        )
//    }
}